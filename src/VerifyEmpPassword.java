...
public class VerifyEmpPassword {

    /*
     * After you update the passwords in employees table,
    ...
    public static boolean checkPassword(String e, String p) throws Exception{
        return verifyCredentials(e,p);
    }
