...
function handleCartResult(resultData) {
    ...
    let cartTableBodyElement = jQuery("#confrimation_body");
    ...
    for (let i = 0; i < resultData['shoppingCartItems'].length; i++) {
        ...
        rowHTML +=
            ...
            "</td>";
        rowHTML += "<td id='movie-quantity-"+i+"'>" +  resultData['shoppingCartItems'][i]["quantity"]+ "</td>";
        rowHTML += "<td id='movie-price-"+i+"'>$" + (1 * parseInt(resultData['shoppingCartItems'][i]["quantity"])) + ".00" + "</td>";
